...
[上一节](https://github.com/moqsien/MyNotes/blob/main/go语言底层实现/go底层设计与实现/7-内存管理/01-内存分配器.md) [下一节](https://github.com/moqsien/MyNotes/blob/main/go语言底层实现/go底层设计与实现/7-内存管理/03-栈内存管理.md)

* * *

1.  “Garbage Collectors \- Serial vs. Parallel vs. CMS vs. G1 \(and what’s new in Java 8\)” <https://blog.overops.com/garbage-collectors-serial-vs-parallel-vs-cms-vs-the-g1-and-whats-new-in-java-8/> [↩︎](#fnref:1)

2.  “An Overview of Memory Management in Rust” <https://pcwalton.github.io/2013/03/18/an-overview-of-memory-management-in-rust.html> [↩︎](#fnref:2)

3.  “Objective-C Automatic Reference Counting \(ARC\)” <https://clang.llvm.org/docs/AutomaticReferenceCounting.html> [↩︎](#fnref:3)

4.  “Tri-color marking” <https://en.wikipedia.org/wiki/Tracing_garbage_collection#Tri-color_marking> [↩︎](#fnref:4)

5.  “Dangling pointer” <https://en.wikipedia.org/wiki/Dangling_pointer> [↩︎](#fnref:5)

6.  “Wikpedia: Memory barrier” <https://en.wikipedia.org/wiki/Memory_barrier> [↩︎](#fnref:6)

7.  P. P. Pirinen. Barrier techniques for incremental tracing. In ACM SIGPLAN Notices, 34\(3\), 20–25, October 1998. <https://dl.acm.org/doi/10.1145/301589.286863> [↩︎](#fnref:7)

8.  E. W. Dijkstra, L. Lamport, A. J. Martin, C. S. Scholten, and E. F. Steffens. On-the-fly garbage collection: An exercise in cooperation. Communications of the ACM, 21\(11\), 966–975, 1978. <https://www.cs.utexas.edu/users/EWD/transcriptions/EWD05xx/EWD520.html> [↩︎](#fnref:8)

9.  T. Yuasa. Real-time garbage collection on general-purpose machines. Journal of Systems and Software, 11\(3\):181–198, 1990. <https://www.sciencedirect.com/science/article/pii/016412129090084Y> [↩︎](#fnref:9)

10.  Paul R Wilson. “Uniprocessor Garbage Collection Techniques” <https://www.cs.cmu.edu/~fp/courses/15411-f14/misc/wilson94-gc.pdf> [↩︎](#fnref:10)

11.  Performance · Go 1.1 Release Notes <https://golang.org/doc/go1.1#performance> [↩︎](#fnref:11)

12.  Changes to the garbage collector · Go 1.3 Release Notes <https://golang.org/doc/go1.3#garbage_collector> [↩︎](#fnref:12)

13.  Go 1.5 concurrent garbage collector pacing <https://docs.google.com/document/d/1wmjrocXIWTr1JxU-3EQBI6BK6KgtiFArkG47XK73xIQ/edit> [↩︎](#fnref:13)

14.  Austin Clements. 2015. “Proposal: Dense mark bits and sweep-free allocation” <https://go.googlesource.com/proposal/+/master/design/12800-sweep-free-alloc.md> [↩︎](#fnref:14)

15.  runtime: shrinkstack during mark termination significantly increases GC STW time <https://github.com/golang/go/issues/12967#issuecomment-171466238> [↩︎](#fnref:15)

16.  Proposal: Eliminate STW stack re-scanning <https://go.googlesource.com/proposal/+/master/design/17503-eliminate-rescan.md> [↩︎](#fnref:16)

17.  Proposal: Eliminate STW stack re-scanning <https://go.googlesource.com/proposal/+/master/design/17503-eliminate-rescan.md> [↩︎](#fnref:17)

18.  Proposal: Separate soft and hard heap size goal <https://go.googlesource.com/proposal/+/master/design/14951-soft-heap-limit.md> [↩︎](#fnref:18)

19.  Proposal: Simplify mark termination and eliminate mark 2 <ttps://go.googlesource.com/proposal/+/master/design/26903-simplify-mark-termination.md> [↩︎](#fnref:19)

20.  Proposal: Smarter Scavenging <https://go.googlesource.com/proposal/+/master/design/30333-smarter-scavenging.md> [↩︎](#fnref:20)

21.  Proposal: Scaling the Go page allocator <https://go.googlesource.com/proposal/+/master/design/35112-scaling-the-page-allocator.md> [↩︎](#fnref:21)

22.  Austin Clements. 2015. “Proposal: Decentralized GC coordination” <https://go.googlesource.com/proposal/+/master/design/11970-decentralized-gc.md> [↩︎](#fnref:22)

23.  Go 1.5 concurrent garbage collector pacing <https://docs.google.com/document/d/1wmjrocXIWTr1JxU-3EQBI6BK6KgtiFArkG47XK73xIQ/edit> [↩︎](#fnref:23)

24.  Proposal: Separate soft and hard heap size goal <https://go.googlesource.com/proposal/+/master/design/14951-soft-heap-limit.md> [↩︎](#fnref:24)

25.  src/runtime/mgc.go <https://golang.org/src/runtime/mgc.go> [↩︎](#fnref:25)

26.  Go 1.5 concurrent garbage collector pacing <https://docs.google.com/document/d/1wmjrocXIWTr1JxU-3EQBI6BK6KgtiFArkG47XK73xIQ/edit> [↩︎](#fnref:26)

27.  runtime: separate soft and hard heap limits <https://github.com/golang/go/commit/03eb9483e37a5c0c9208cff17138a94f44e4d6a1> [↩︎](#fnref:27)