...
![golang-array-memory](https://gitlab.com/moqsien/go-design-implementation/-/raw/main/golang-array-memory.png)
...
[上一节](https://github.com/moqsien/MyNotes/blob/main/go语言底层实现/go底层设计与实现/2-编译原理/05-机器码的生成.md) [下一节](https://github.com/moqsien/MyNotes/blob/main/go语言底层实现/go底层设计与实现/3-数据结构/02-切片.md)
